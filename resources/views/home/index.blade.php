      ...
      <div class="col-md-4">
         <div class="card">
            ...
            <div class="card-footer" style="text-align: center">
               <a href="{{route('activity-logs-view')}}" class="btn btn-link text-center"><strong>Show All</strong></a>
            </div>
            @else
            <div class="card-footer" style="text-align: center">
               ...
               <div class="col-lg-4">
                  <div class="card widget-flat">
                     <div class="card-body">
                        ...
                        <h3 class="text-muted font-weight-normal mb-3">$ {{$getTotalPaidAmount + $getTotalRemainingAmount}}</h3>
                     ...
                     <div class="card-header">
                        <div class="d-flex justify-content-between">
                           ...
                           <div class="form-group">
                              ...
                              <select id="theoryExamRecords" class="form-control" onchange="changeTheoryExamRecords(this.value)">
                  ...
                  <div class="card">
                     <div class="card-header">
                        <div class="d-flex justify-content-between">
                           ...
                           <div class="form-group">
                              ...
                              <select id="knowledgeTestRecords" class="form-control" onchange="changeKnowledgeTestRecords(this.value)">
                                 <option value="10">10</option>
                                 <option value="20">20</option>
                                 <option value="30">30</option>
                              </select>
                     ...
                     <div class="card-body">
                        <ul class="list-group list-group-flush" id="upcomingKnowledgeTestsList">
                           ...
                           <li class="list-group-item">
                              {{ $test->getFullNameAttribute() }} - {{ $test->knowledge_test_date }} {{ date('h:i A', strtotime($test->knowledge_test_time)) }}
                           </li>
                           @endforeach
                        </ul>
                     </div>
