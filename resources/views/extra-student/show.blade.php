...
<div class="row">
    <div class="col-6">
        <div class="page-title-box">
            <h4 class="page-title">Extra Student Profile</h4>
        </div>
    </div>
    <div class="col-6">
        <div class="page-title-box">
            @can('student-edit')
                <a href="{{route('extrastudents.edit',$students->id)}}" class="mt-2 btn btn-primary float-right" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="edit student">
                    Edit Student
                </a>
            @endcan
            <a href="{{route('extrastudents.index')}}" class="mt-2 btn btn-secondary float-right mr-2">
                Back
            </a>
        </div>
    </div>
                    ...
                    @can('student-status')
                        ...
                        <form action="" method="post" id="studentStatusForm">
                            ...
                            <select name="student_status" id="student_status" class="form-control">
                                    <option value="extra student" class="text-capitalize" selected>Extra Student</option>
                            </select>
                            </div>
                        </form>
                    @endcan
                    ...
                    <div class="tab-pane" id="exams">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="text-left mt-3">
                                        <p class="text-muted mb-2 font-15"><strong>Theroy Exam
                                                Date:</strong><span
                                                class="ml-2 mt-1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="text-left mt-3">
                                        <p class="text-muted mb-2 font-15"><strong>Time:</strong><span
                                                class="ml-2 mt-1"> <br>{{date('h:i A', strtotime($students->knowledge_test_time)) ?? 'N/A'}}</span></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="text-left mt-3">
                                        <p class="text-muted mb-2 font-15"><strong>Location:</strong><span
...
$(document).ready(function(){
    ...
    $(document).on('change','#student_status',function(e){
        ...
        $.ajax({
        url: "{{route('extrastudents.change-status')}}",
        type: "POST",
