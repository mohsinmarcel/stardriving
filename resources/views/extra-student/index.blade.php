...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title">Extra Students</h4>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title mb-4">List of Extra Students
                    @can('student-create')
                        <a href="{{route('extrastudents.create')}}" class="btn btn-primary float-right">Add Extra Student</a>
                    @endcan
                    <a href="{{route('extrastudents.qrCodeDownload')}}" class="btn btn-primary float-right" style="margin-right: 15px">Download All QR-Code</a>
                </h4>
                        ...
                        @foreach ($students as $key => $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @can('student-profile')
                                    <a href="{{route('extrastudents.show',$item->student_id)}}" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="View" class="btn btn-info p-1" style="font-size: 1.3rem">
                                        <i class="uil uil-eye"></i>
                                    </a>
                                    @endcan
                                    @can('student-edit')
                                        <a href="{{route('extrastudents.edit',$item->id)}}" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Edit" class="btn btn-info p-1" style="font-size: 1.3rem">
...
<script>
    ...
    @can('student-delete')
        $(document).on('click','#deleteButton',function(){
            ...
            let route = '{{route("extrastudents.destroy",0)}}'
