...
<div class="row">
    <div class="col-12">
        <form action="{{route('rates.update.process')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="header-title">Rates Show</div>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="year" readonly class="form-control @error('year') is-invalid @enderror" name="year" value="{{$rates[0]->class_name}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="module" readonly class="form-control @error('module') is-invalid @enderror" name="module[]" value="{{old('module',$rate->module)}}">
                                            @error('module')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="no_of_hours" readonly class="form-control @error('no_of_hours') is-invalid @enderror" name="no_of_hours[]" value="{{old('no_of_hours',$rate->no_of_hours)}}">
                                            @error('no_of_hours')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="hourly_rate" readonly class="form-control @error('hourly_rate') is-invalid @enderror" name="hourly_rate[]" value="{{old('hourly_rate',$rate->hourly_rate)}}">
                                            @error('hourly_rate')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                        ...
                        <div class="col-md-12 text-right mt-1">
                            <a href="{{route('rates.index')}}" type="button" class="btn btn-secondary waves-effect">Back</a>
