...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title">Quarters</h4>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title mb-4">List of quarters
                  
                        <button href="javascript:void(0);" id="addExamType" class="btn btn-primary float-right">Add Quarter</button>
...
<script>
    ...
    $('#addExamType').click(function (e) { 
        ...
        $.get( "{{route('quarters.create')}}", function( data ) {
    ...
    $('.editExamType').click(function (e) { 
        ...
        $('#frontPagesModal').modal('show');
        $.get( "/quarters/"+id+"/edit", function( data ) {
            $('#frontPagesModal .modal-dialog').addClass('modal-md');
    ...
    $(document).on('click','.deleteButton',function(){
            ...
            let route = '{{route("quarters.destroy",0)}}'
            route = route.replace(/quarters\/\d/g,'quarters/'+dataId)
