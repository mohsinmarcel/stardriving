...
class ExtraStudentController extends Controller
{
     /**
    ...
    public function index()
    {
        ...
        {
            $students = Student::where('isextrastudent', true)->get();
            return view('extra-student.index',\compact('students'));
        }
        else
        {
            return abort(401);
    ...
    public function create()
    {
        ...
        return view('extra-student.create',compact('conditions','payment_methods','taxes','rates', 'locations'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            StudentCourseDetail::create([
                'theoretical_credit_hours'=> 0,
                'practical_credit_hours'=> 0,
        ...
        return redirect()->route('extrastudents.index')->with('success','Student created successfully');
    }
    ...
    public function edit($id)
    {
        ...
        return view('extra-student.edit',compact('students','conditions','studentLicenses','studentCourseDetail','taxes','studentContract','studentDocuments','studentMedicalCondition','locations'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('extrastudents.index')->with('success','Student updated successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        $student = Student::findOrFail($id);
        $student->delete();
        return redirect()->route('extrastudents.index')->with('success','Student deleted successfully');
    }
    ...
    public function blukQrCodeImageDownload()
    {
        ...
        if(count($students)==0){
            return redirect()->route('extrastudents.index')->with('error','There is no student data right now');//->download
        }
        ...
        return redirect()->route('extrastudents.index')->with('success','Starting Student QrCode Downloading');//->download(public_path($fileName));
